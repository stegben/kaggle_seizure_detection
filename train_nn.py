...
def my_model(input_dim):
    ...
    encoded_image = GaussianNoise(sigma=0.0005)(image_input)
    encoded_image = Convolution2D(8, 3, 3, border_mode='valid', dim_ordering='th', W_regularizer=l2(0.0001))(encoded_image)
    ...
    encoded_image = Convolution2D(16, 5, 5, border_mode='valid', dim_ordering='th', W_regularizer=l2(0.00005))(encoded_image)
    encoded_image = BatchNormalization(axis=1)(encoded_image)
    encoded_image = Activation('relu')(encoded_image)
    encoded_image = MaxPooling2D(pool_size=(2, 2), dim_ordering='th')(encoded_image)
    encoded_image = Dropout(0.5)(encoded_image)
    encoded_image = Convolution2D(16, 7, 7, border_mode='valid', dim_ordering='th', W_regularizer=l2(0.00005))(encoded_image)
    encoded_image = BatchNormalization(axis=1)(encoded_image)
    encoded_image = Activation('relu')(encoded_image)
    encoded_image = MaxPooling2D(pool_size=(3, 3), dim_ordering='th')(encoded_image)
    encoded_image = Dropout(0.5)(encoded_image)
    encoded_image = Flatten()(encoded_image)

    pid_input = Input(shape=(3,))
    encoded_pid = Dense(1, init='he_normal',W_regularizer=l2(1.0))(pid_input)
    encoded_pid = Activation('tanh')(encoded_pid)
    encoded_pid = Dropout(0.8)(encoded_pid)
    ...
    output = Dense(200, init='he_normal', W_regularizer=l1(0.0001))(merged)
    output = PReLU(init='zero', weights=None)(output)
    output = Dropout(0.5)(output)
    output = Dense(200, init='he_normal', W_regularizer=l2(0.0001))(output)
    output = PReLU(init='zero', weights=None)(output)
    output = Dropout(0.5)(output)
