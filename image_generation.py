...
def main():
    ...
    test_1_data_path_pattern = '../raw_data/test_1/*.mat'
    test_2_data_path_pattern = '../raw_data/test_2/*.mat'
    test_3_data_path_pattern = '../raw_data/test_3/*.mat'

    output_data_name = '../cnn_' + sys.argv[1]

    print('create_data')
    train_1_x, train_1_y, train_1_metadata = create_data(train_1_data_path_pattern, FRAME_SIZE, FRAME_SPACING, False)
    train_2_x, train_2_y, train_2_metadata = create_data(train_2_data_path_pattern, FRAME_SIZE, FRAME_SPACING, False)
    train_3_x, train_3_y, train_3_metadata = create_data(train_3_data_path_pattern, FRAME_SIZE, FRAME_SPACING, False)
